...
class _ListingDetailsPageState
  ...
  @override
  Widget get view {
    return ControlledWidgetBuilder<ListingDetailsController>(
                              ...
                              onPressed: () async {
                                ...
                                if (currentUser.accountStatus !=
                                  ...
                                  String? pdfFilePath = await PdfGenerator()
                                      .downloadPdf(property: selectedListing);
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                      ...
                                      color:
                                          Color.fromRGBO(168, 238, 252, 1.0)),
                                  child: Image.asset(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Image(
                              image: AssetImage('assets/icons/dazle_icon.png')),
                          SizedBox(
                            height: 10,
                          ),
                          Container(
