...
class MapLocationPicker extends View {
  ...
  _MapLocationPickerState createState() => _MapLocationPickerState(
      initialCameraPosition: initialCameraPosition, viewOnly: this.viewOnly);
}

class _MapLocationPickerState
    extends ViewState<MapLocationPicker, MapLocationPickerController> {
  _MapLocationPickerState(
      {CameraPosition? initialCameraPosition, bool viewOnly = false})
      : super(MapLocationPickerController(
            initialCameraPosition: initialCameraPosition, viewOnly: viewOnly));
  ...
  Widget get view {
    return ControlledWidgetBuilder<MapLocationPickerController>(
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          title: CustomText(
              text: "Property Map Location", fontWeight: FontWeight.bold),
          ...
          Stack(children: [
            GoogleMap(
              ...
              onCameraMove: (CameraPosition cameraPosition) {
                if (!widget.viewOnly) {
                  print("UPDATETIN ONCAMERAOs");
                  controller.changePropertyCameraPositionTarget(LatLng(
                ...
                ? Center(
                    child: Padding(
                      padding: EdgeInsets.only(
                          bottom:
                              controller.propertyPositionTargetIconSize * 0.80),
                      child: Icon(
                        Icons.location_on,
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: CustomButton(
                      ...
                      onPressed: () {
                        Navigator.pop(
                            context, controller.propertyCameraPositionTarget);
                      },
