...
class RemoveConnectionUseCase extends UseCase<RemoveConnectionUseCaseResponse,
  ...
  @override
  Future<Stream<RemoveConnectionUseCaseResponse>> buildUseCaseStream(
      RemoveConnectionUseCaseParams? params) async {
    ...
    try {
      ...
      // if (user != null) {
      await dataConnectionRepository.removeConnection(
          userId: user.id, invitedId: params!.invitedId);
